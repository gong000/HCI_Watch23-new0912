...
public class BTAP_View extends View {
    float bezel_X=0;
    float bezel_Y=0;
    int area_num=0;
    ...
    Vibrator v;
    Paint paint;
    public BTAP_View(Context context) {
        super(context);
        v=(Vibrator)context.getSystemService(Context.VIBRATOR_SERVICE);
        init();
    }

    public BTAP_View(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        v=(Vibrator)context.getSystemService(Context.VIBRATOR_SERVICE);
        init();
    }
